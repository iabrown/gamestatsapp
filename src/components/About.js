    ...
    <div id="wrapper">
      ...
      <section>
        ...
        <div className="content">
          ...
          <p>Programming languages include HTML, CSS, Javascript, C++, PHP, MySQL, React/Node.js and familiarity with various frameworks and libraries. </p>
        </div>
      </section>
